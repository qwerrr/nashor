...
import com.zhangyue.test.nashor.framework.zookeeper.common.curator.watcher.GetChildrenWatcher;
...
public class NodeChildrenChangedWatcher extends GetChildrenWatcher {
    ...
    public NodeChildrenChangedWatcher(ZkCuratorService zkService, Watcher watcher, String path) {
